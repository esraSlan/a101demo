...
public class Driver {
    ...
    public static WebDriver getDriver() {
        ...
        if (driverPool.get() == null) {
            String browserParamFromEnv = ConfigReader.getProperty("browser");
            ...
            switch (browser) {
                ...
                case "remote_chrome":
                    try {
                        ...
                        driverPool.set(new RemoteWebDriver(new URL(ConfigReader.getProperty("remootURI")), desiredCapabilities));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    break;
